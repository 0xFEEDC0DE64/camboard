...
INCLUDEPATH += "$${HOMEDIR}/camera/lib/OneButton/src"
INCLUDEPATH += "$${HOMEDIR}/camera/lib/esp8266-oled-ssd1306/src"
...
INCLUDEPATH += "$${HOMEDIR}/camera/include"
INCLUDEPATH += "$${HOMEDIR}/camera/src"
